...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="/banksystem/style/style.css">
	<link rel="stylesheet" type="text/css" href="/banksystem/style/default.css">
...
<script type="text/javascript">
	function check()
	{
		...
		{
				document.getElementById("errorbirthday").innerHTML="请输入生日";
				return false;
		}else
		{
			if(pwd!=confirmpwd)
			...
			/* if(!(birthday.search(/^[\+\-]?\d+\.?\d*$/)==0))
			{
				
				document.getElementById("errorbirthday").innerHTML="含有非法字符";
				return false;
			}else{
				if(parseFloat(age)<18)
				{
  ...
  <body>
  <form method="post" name="myform" action="/banksystem/admin/kaihu" onsubmit="return check()">
  <div align="center">
  	<table width="450" class="table table-bordered definewidth m10">
			<tbody>
				...
				<tr>
					<td>生日：</td>
					<td>
						<input id="birthday" type="text" name="personinfo.birthday""/>
						<span id="errorage" style="color:red;"></span>
					</td>
				</tr>
				<tr>
